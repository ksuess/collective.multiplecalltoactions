# -*- coding: utf-8 -*-
from collective.multiplecalltoaction.behaviors.call_to_action_behavior import ICallToActionBehavior
...
class CallToActionBehaviorIntegrationTest(unittest.TestCase):
    ...
    def test_behavior_call_to_action_behavior(self):
        behavior = getUtility(IBehavior, 'collective.multiplecalltoaction.call_to_action_behavior')
        self.assertEqual(
            behavior.marker,
            ICallToActionBehavior,
        )
        behavior_name = 'collective.multiplecalltoaction.behaviors.call_to_action_behavior.ICallToActionBehavior'
