# -*- coding: utf-8 -*-
from collective.calltoaction.behaviors.call_to_action_behavior import ICallToActionBehavior
...
class CallToActionBehaviorIntegrationTest(unittest.TestCase):
    ...
    def test_behavior_call_to_action_behavior(self):
        behavior = getUtility(IBehavior, 'collective.calltoaction.call_to_action_behavior')
        self.assertEqual(
            behavior.marker,
            ICallToActionBehavior,
        )
        behavior_name = 'collective.calltoaction.behaviors.call_to_action_behavior.ICallToActionBehavior'
