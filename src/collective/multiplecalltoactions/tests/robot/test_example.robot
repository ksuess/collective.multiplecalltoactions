...
#
#  $ bin/test -s collective.multiplecalltoactions -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src collective.multiplecalltoactions.testing.COLLECTIVE_CALLTOACTION_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
