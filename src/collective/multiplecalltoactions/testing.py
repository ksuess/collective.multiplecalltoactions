...
import collective.multiplecalltoactions
...
class CollectiveCalltoactionLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        # layer.
        self.loadZCML(package=collective.multiplecalltoactions)

    def setUpPloneSite(self, portal):
        applyProfile(portal, 'collective.multiplecalltoactions:default')
